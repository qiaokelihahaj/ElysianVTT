...
async function main() {
    ...
    // 1. 播种技能模板
    await prisma_js_1.prisma.actionTemplate.upsert({
    ...
    // 2. 播种角色数据
    await prisma_js_1.prisma.characterSheet.upsert({
...
main().catch(e => console.error(e)).finally(() => prisma_js_1.prisma.$disconnect());
